...
class AuthenticationStateService extends ChangeNotifier {
  static final AuthenticationStateService _instance = AuthenticationStateService._internal();
  ...
  Future<void> setAuthenticatedUser({
    ...
    if (kDebugMode) {
      debugPrint('AuthenticationStateService: User authenticated as $nickname (UID: $uid)');
    }
  ...
  Map<String, dynamic> getDebugInfo() {
    return {
      ...
      'currentFirebaseUserEmail': FirebaseAuth.instance.currentUser?.email ?? 'none',
    };
  }
}