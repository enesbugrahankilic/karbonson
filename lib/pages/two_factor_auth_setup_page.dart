            ...
            PopupMenuButton<String>(
              ...
              itemBuilder: (context) => [
                ...
                PopupMenuItem(
                  value: 'advanced',
                  child: ListTile(
                    leading: Icon(_showAdvancedOptions
                        ? Icons.expand_less
                        : Icons.expand_more),
            ...
            children: [
              ...
              SizedBox(
                ...
                child: ElevatedButton.icon(
                  onPressed: (_isProcessing || !_smsCodeEntered)
                      ? null
                      : _finalize2FASetup,
                  icon: _isProcessing
                      ? const SizedBox(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SwitchListTile(
                      ...
                      subtitle: const Text(
                          'Acil durumlar için 8 adet yedek kod oluştur'),
                    ...
                    SwitchListTile(
                      ...
                      subtitle: const Text(
                          'Parmak izi/yüz tanıma ile hızlı giriş (Yakında)'),
        ...
        child: Column(
          ...
          children: [
            ...
            ListTile(
              ...
              subtitle: const Text(
                  '8 haneli yedek kodunuz varsa buradan giriş yapabilirsiniz'),
              onTap: () {
                setState(() {
                  _useBackupCode = true;
                });
                      ...
                      children: [
                        Expanded(
                          child: ElevatedButton(
                            onPressed:
                                _isProcessing ? null : _verifyWithBackupCode,
                            child: Text(
