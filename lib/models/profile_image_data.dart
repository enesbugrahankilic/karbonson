...
class ProfileImageData {
  ...
  bool get isProcessing =>
      uploadProgress.status == ImageUploadStatus.optimizing ||
  ...
  factory ProfileImageData.fromJson(Map<String, dynamic> json) {
    return ProfileImageData(
      ...
      optimizationParams:
          ImageOptimizationParams.fromJson(json['optimizationParams'] ?? {}),
      ...
      uploadProgress: UploadProgress(
        ...
        progress:
            (json['uploadProgress']['progress'] as num?)?.toDouble() ?? 0.0,
        ...
        endTime: json['uploadProgress']['endTime'] != null
            ...
            : null,
        estimatedTimeRemaining: json['uploadProgress']
            ['estimatedTimeRemaining'],
      ),
